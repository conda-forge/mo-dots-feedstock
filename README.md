...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mo-dots-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11057&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mo-dots-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mo-dots` can be installed with:

```
conda install mo-dots
```

It is possible to list all of the versions of `mo-dots` available on your platform with:
